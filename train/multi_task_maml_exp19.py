...
class MultiTaskTrainer(Trainer):
    def __init__(self, config) -> None:
        ...
        self.optimizer = torch.optim.Adam(self.ppo.policy.actor.parameters(), self.meta_lr)
        self.optimizer_critic = torch.optim.Adam(self.ppo.policy.critic.parameters(), self.meta_lr)
